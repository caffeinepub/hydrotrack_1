...
export class Backend implements backendInterface {
    ...
    async getDailyGoal(): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getTodaySummary(): Promise<Summary> {
        if (this.processError) {
            try {
    ...
    async getTodaysEntries(): Promise<Array<WaterEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodaysEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getWeeklyEntries(): Promise<Array<WaterEntry>> {
        if (this.processError) {
            try {
    ...
    async logWaterIntake(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logWaterIntake(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
